...
export const scuttlebuttEn = {
  ...
  "settings.trigger": "Model settings",
  "settings.row.cli": "Agent CLI",
  "settings.row.model": "Model",
  "settings.row.reasoning": "Reasoning",
...
export const scuttlebuttKo: Record<ScuttlebuttMessageKey, string> = {
  ...
  "settings.trigger": "모델 설정",
  "settings.row.cli": "에이전트 CLI",
  "settings.row.model": "모델",
  "settings.row.reasoning": "추론 강도",
