...
export const scuttlebuttEn = {
  ...
  "settings.section.experimentalHint": "The admirals are new and still finding their footing. Everything here starts off — turn on whoever you want aboard.",
...
export const scuttlebuttKo: Record<ScuttlebuttMessageKey, string> = {
  ...
  "settings.section.experimentalHint": "제독단은 아직 자리를 잡는 중인 새 기능입니다. 모든 항목이 꺼진 채로 시작하니 태울 제독만 켜 주세요.",
