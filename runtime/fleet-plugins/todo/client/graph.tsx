...
export function CoordinationGraph({ item, t, modeLabel, onToggleEdge, onCycle, operationTitle }: GraphProps) {
  ...
  const W = 320;
  const colW = columns ? Math.min(92, (W - 84) / Math.max(columns, 1)) : 0;
  const rowH = 42;
