...
const KOREAN_COPY = {
  ...
  "ERROR": "오류",
  "IDLE": "대기",
  "No carriers streaming.": "스트리밍 중인 캐리어가 없습니다.",
  "The next dispatch from this operation appears here the moment it begins.": "이 오퍼레이션의 다음 디스패치가 시작되는 즉시 여기에 표시됩니다.",
  "Reasoning…": "추론 중…",
  "Expand completed stream": "완료된 스트림 펼치기",
  "Collapse completed stream": "완료된 스트림 접기",
  "Activity": "활동",
