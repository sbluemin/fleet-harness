...
describe("Session Analyst contract", () => {
  ...
  it("registers Carrier Streams first and keeps both Analyst panels hidden by default", () => {
    ...
    expect(source).toContain('id: CARRIER_STREAMS_COMPANION_ID, title: (locale) => getT(locale)("terminal.companion.carrierStreams"), hideCaption: true, defaultHidden: true, available: operationSupportsCarrierStreams');
