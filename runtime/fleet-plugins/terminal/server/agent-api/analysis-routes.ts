...
const ANALYSIS_ARTIFACT_THEMES = new Set(["instrument", "maritime", "carbon", "daywatch", "whites", "drydock"]);
const ANALYSIS_ARTIFACT_LIGHT_THEMES = new Set(["daywatch", "whites", "drydock"]);
