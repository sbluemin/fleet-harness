...
const ANALYSIS_ARTIFACT_THEMES = new Set(["instrument", "maritime", "carbon", "daywatch", "chartroom", "whites", "drydock"]);
const ANALYSIS_ARTIFACT_LIGHT_THEMES = new Set(["daywatch", "chartroom", "whites", "drydock"]);
