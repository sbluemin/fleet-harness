...
const repositoryEn = {
  ...
  "repository.section.remotes": "REMOTES",
  ...
  "repository.verb.more": "More actions",
  "repository.verb.menu": "Remote and stash actions",
  "repository.discovery.depthTitle": "Scan depth",
  "repository.discovery.rescan": "Rescan repositories",
  "repository.refs.worktreeBranch": "Checked out here",
  "repository.refs.upstreamGone": "Upstream gone",
  "repository.refs.aheadBehind": "{ahead} ahead · {behind} behind",
  "repository.refs.current": "Current branch",
  "repository.remote.host": "Remote host",
  ...
  "repository.dock.collapse": "Collapse (keep viewing)",
  "repository.dock.expand": "Expand",
  "repository.dock.toFull": "Expand to full",
  "repository.dock.toHalf": "Back to half",
  "repository.dock.detentHalf": "half",
  "repository.dock.detentFull": "full",
  "repository.dock.detentCollapse": "collapse",
  "repository.dock.limitMin": "min {px}",
  "repository.dock.limitMax": "max {px} — keeps 3 graph rows",
  "repository.dock.parent": "parent",
  "repository.dock.child": "child",
  "repository.dock.parentTitle": "Go to parent {short} (⌥↑)",
  "repository.dock.childTitle": "Go to child {short} (⌥↓)",
  "repository.dock.parentNone": "No parent loaded",
  "repository.dock.childNone": "No child in the loaded log",
  "repository.dock.fileCounter": "{index} / {count}",
  "repository.dock.showMore": "Show more",
  "repository.dock.showLess": "Show less",
  "repository.dock.peekReturnTo": "History ↑",
  "repository.compare.armBase": "base {short}",
  "repository.compare.armHint": "Click a commit in the graph to compare — one click completes it",
  "repository.compare.armCancel": "Cancel",
  "repository.compare.pinShort": "Compare",
  ...
  "repository.filetree.pickHint": "Pick a file to read it at this commit. Changed files open as a diff.",
  "repository.filetree.changedHere": "Changed in this commit",
  "repository.filetree.binary": "Binary file — no preview.",
  "repository.filetree.fileMissing": "This file does not exist at this commit.",
  "repository.filetree.contentError": "Unable to read this file at this commit.",
  "repository.filetree.contentTruncated": "Preview cut off — the file is larger than the preview limit.",
...
const repositoryKo: Record<keyof typeof repositoryEn, string> = {
  ...
  "repository.verb.stash": "Stash",
  "repository.verb.more": "더 보기",
  "repository.verb.menu": "원격·스태시 동작",
  "repository.discovery.depthTitle": "탐색 깊이",
  "repository.discovery.rescan": "저장소 다시 스캔",
  "repository.refs.worktreeBranch": "이 워크트리에 체크아웃됨",
  "repository.refs.upstreamGone": "업스트림 없음",
  "repository.refs.aheadBehind": "{ahead} 앞섬 · {behind} 뒤처짐",
  "repository.refs.current": "현재 브랜치",
  "repository.remote.host": "원격 호스트",
  ...
  "repository.dock.collapse": "접기 (보던 커밋 유지)",
  "repository.dock.expand": "펼치기",
  "repository.dock.toFull": "전체로 펼치기",
  "repository.dock.toHalf": "절반으로",
  "repository.dock.detentHalf": "절반",
  "repository.dock.detentFull": "전체",
  "repository.dock.detentCollapse": "접기",
  "repository.dock.limitMin": "최소 {px}",
  "repository.dock.limitMax": "최대 {px} — 그래프 3행 보존",
  "repository.dock.parent": "부모",
  "repository.dock.child": "자식",
  "repository.dock.parentTitle": "부모 {short}로 이동 (⌥↑)",
  "repository.dock.childTitle": "자식 {short}로 이동 (⌥↓)",
  "repository.dock.parentNone": "적재된 부모가 없습니다",
  "repository.dock.childNone": "적재된 기록에 자식이 없습니다",
  "repository.dock.fileCounter": "{index} / {count}",
  "repository.dock.showMore": "더 보기",
  "repository.dock.showLess": "접기",
  "repository.dock.peekReturnTo": "기록으로 ↑",
  "repository.compare.armBase": "기준 {short}",
  "repository.compare.armHint": "그래프에서 비교할 커밋을 클릭하세요 — 한 번의 클릭으로 비교가 열립니다",
  "repository.compare.armCancel": "취소",
  "repository.compare.pinShort": "비교",
  ...
  "repository.filetree.pickHint": "파일을 고르면 이 커밋 시점의 내용을 보여 줍니다. 바뀐 파일은 diff로 열립니다.",
  "repository.filetree.changedHere": "이 커밋에서 변경됨",
  "repository.filetree.binary": "바이너리 파일 — 미리보기가 없습니다.",
  "repository.filetree.fileMissing": "이 커밋에는 이 파일이 없습니다.",
  "repository.filetree.contentError": "이 커밋의 파일 내용을 읽지 못했습니다.",
  "repository.filetree.contentTruncated": "미리보기가 잘렸습니다 — 파일이 미리보기 상한보다 큽니다.",
