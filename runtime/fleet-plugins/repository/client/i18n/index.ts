...
export const repositoryEn = {
  ...
  "repository.verb.pushed": "Pushed {branch} to {remote}",
  "repository.verb.pulled": "Pulled {branch} from {remote}",
  "repository.verb.stashed": "Stashed working changes",
...
export const repositoryKo: Record<keyof typeof repositoryEn, string> = {
  ...
  "repository.verb.pushed": "{branch}를 {remote}로 push했습니다",
  "repository.verb.pulled": "{remote}에서 {branch}를 pull했습니다",
  "repository.verb.stashed": "작업 중 변경을 스태시했습니다",
