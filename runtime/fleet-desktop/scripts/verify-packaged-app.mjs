...
async function assertShellOnlyAsar(asar) {
  ...
  if (!entryHtml.includes("default-src 'none'; style-src 'self'; script-src 'none'; connect-src 'none'; img-src 'none'; font-src 'self'; object-src 'none'; frame-src 'none'; worker-src 'none'; base-uri 'none'; form-action 'none'")) throw new Error("Entry CSP contract is missing");
