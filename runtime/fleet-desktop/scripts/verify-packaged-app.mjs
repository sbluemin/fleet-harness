...
async function assertShellOnlyAsar(asar) {
  ...
  const required = ["dist/assets/entry/index.html", "dist/assets/entry/entry.css", "dist/build/node-runtime.json", "dist/build/trayTemplate.png", "dist/build/trayTemplate@2x.png"];
