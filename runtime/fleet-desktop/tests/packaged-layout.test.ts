...
const requiredAsarFiles = ["dist/assets/entry/index.html", "dist/assets/entry/entry.css", "dist/build/node-runtime.json", "dist/build/icon.png", "dist/build/trayTemplate.png", "dist/build/trayTemplate@2x.png"];
