...
const requiredAsarFiles = ["dist/assets/entry/index.html", "dist/assets/entry/entry.css", "dist/assets/entry/fonts/fraunces-latin-wght-normal.woff2", "dist/assets/entry/fonts/manrope-latin-wght-normal.woff2", "dist/build/node-runtime.json", "dist/build/icon.png", "dist/build/trayTemplate.png", "dist/build/trayTemplate@2x.png"];
...
describe("shell-only packaged layout", () => {
  ...
  it("packages the passive entry asset with the Node manifest inside ASAR without Console payload", () => {
    for (const resources of findResourceDirectories()) {
