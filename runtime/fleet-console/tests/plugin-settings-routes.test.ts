...
import { createPluginSettingsRouter } from "../features/settings/host/settings-domain.js";
import type { ConsoleSettingsData } from "../features/settings/host/settings-domain.js";
