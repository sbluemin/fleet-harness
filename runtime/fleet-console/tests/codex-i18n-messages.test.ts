...
import { ko } from "../client/src/codex/i18n/messages/ko";
import { en } from "../client/src/codex/i18n/messages/en";
import { flattenKeys, validateKeysets } from "../client/src/codex/i18n/t";
...
describe("missing key fallback", () => {
  it("t() returns key string for unknown keys", async () => {
    const { t } = await import("../client/src/codex/i18n/t");
