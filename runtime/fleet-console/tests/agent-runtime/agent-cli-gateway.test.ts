...
import { FLEET_PLUGIN_NAME, GENERAL_PURPOSE_AGENT_PROMPT, buildGatewayAgentSpecs, buildGatewayCustomAgents, toGatewayAgentName } from "@fleet-console/ai-gateway";
