...
describe("published Console manifest", () => {
  it("removes workspace specifiers from every copied dependency section", () => {
    ...
    expect(manifest.dependencies).toEqual({ "node-pty": "^1.0.0", "@anthropic-ai/claude-agent-sdk": "^0.3.269", ws: "^8.18.0", "font-list": "^2.1.0", "@vscode/ripgrep": "1.18.0", selfsigned: "^5.5.0", esbuild: "0.27.7", "@modelcontextprotocol/sdk": "1.30.0", tar: "7.5.22", fflate: "0.8.2" });
  });
});
