...
const SETTINGS = { consolePortMode: "dynamic", consoleStaticPort: null, seenFeatureTours: [], seenDeveloperNotes: [], theme: "instrument", uiFont: { source: "builtin", id: "manrope", size: 14 }, language: "auto" } as const;
