...
export default defineConfig([
  {
    entry: { fleet: "cli/fleet-entry.ts", cli: "core/host/bootstrap/cli.ts", "access-protocol": "features/remote-access/host/access-link.ts", "desktop-protocol": "core/host/shell/desktop-protocol.ts", "fleet-plugins/repository/routes": "../fleet-plugins/repository/routes.ts", "fleet-plugins/file-explorer/routes": "../fleet-plugins/file-explorer/routes.ts", "fleet-plugins/skills/routes": "../fleet-plugins/skills/routes.ts", "fleet-plugins/ledger/routes": "../fleet-plugins/ledger/routes.ts", "fleet-plugins/quota/routes": "../fleet-plugins/quota/routes.ts", "fleet-plugins/scuttlebutt/routes": "../fleet-plugins/scuttlebutt/routes.ts", "fleet-plugins/codex/routes": "../fleet-plugins/codex/routes.ts", "fleet-plugins/objectives/routes": "../fleet-plugins/objectives/routes.ts" },
    format: ["esm"],
