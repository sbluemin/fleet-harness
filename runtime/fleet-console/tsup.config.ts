...
export default defineConfig([
  {
    ...
    dts: { entry: { cli: "core/host/cli.ts", "access-protocol": "access-protocol/index.ts" }, resolve: true },
    sourcemap: false,
    clean: false,
