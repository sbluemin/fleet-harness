...
export default defineConfig([
  {
    ...
    noExternal: [/^@fleet-plugins\//,/^@dotobokuri\/core-process(\/|$)/, /^@dotobokuri\//, /^@fleet-console\/(sdk|markdown|font-picker|desktop-protocol|access-protocol)(\/|$)/, "@clack/prompts", /^@clack\//, /^zod(\/|$)/],
