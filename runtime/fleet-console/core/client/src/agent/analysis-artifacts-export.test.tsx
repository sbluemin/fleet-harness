...
describe("Session Analyst artifact export", () => {
  ...
  it("downloads the host-wrapped document with a sanitized title", async () => {
    ...
    expect(fetchDocument).toHaveBeenCalledWith(expect.stringContaining("/api/v1/analysis/artifacts/artifact-active"));
  ...
  it("opens the active artifact in a noopener tab", () => {
    ...
    expect(open).toHaveBeenCalledWith(
      "/api/v1/analysis/artifacts/artifact-active?theme=dark&ground=Canvas&foreground=CanvasText",
      "_blank",
      "noopener",
    );
    expect(document.activeElement).toBe(exportButton);
