...
export const CHORD_KEY_CODE = /^(?:Key[A-Z]|Digit[0-9]|F(?:[1-9]|1[0-2])|Space|Arrow(?:Up|Down|Left|Right)|Minus|Equal|BracketLeft|BracketRight|Semicolon|Quote|Comma|Period|Slash|Backslash|Backquote)$/u;
...
export type RecordedChordVerdict =
  ...
  | { readonly kind: "reject"; readonly reason: "no-modifier" | "blocked" };
