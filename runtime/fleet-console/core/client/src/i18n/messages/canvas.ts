export const canvasEn = {
  ...
  "cluster.strip.aria": "{title} · {done} of {total} steps done",
  "cluster.picker.aria": "Operations of {title}",
  "cluster.picker.coordinator": "Chef",
  "cluster.picker.open": "Open the to-do item",
  "cluster.picker.count.aria": "{done} of {total} steps done",
...
export const canvasKo: Record<keyof typeof canvasEn, string> = {
  ...
  "cluster.strip.aria": "{title} · {total}단계 중 {done} 완료",
  "cluster.picker.aria": "{title}의 Operation",
  "cluster.picker.coordinator": "셰프",
  "cluster.picker.open": "할 일 열기",
  "cluster.picker.count.aria": "{total}단계 중 {done} 완료",
