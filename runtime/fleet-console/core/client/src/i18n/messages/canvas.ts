export const canvasEn = {
  ...
  "canvas.snap.assistTitle": "Fill this slot",
  "canvas.snap.assistPickTitle": "Place {title} here",
  "canvas.snap.assistNone": "No other panel to place",
  "canvas.snap.assistMore": "+{count} more — find them with search",
...
export const canvasKo: Record<keyof typeof canvasEn, string> = {
  ...
  "canvas.snap.assistTitle": "이 칸에 넣기",
  "canvas.snap.assistPickTitle": "{title}을(를) 여기에 배치",
  "canvas.snap.assistNone": "넣을 다른 패널이 없습니다",
  "canvas.snap.assistMore": "+{count}개 더 — 검색으로 찾기",
