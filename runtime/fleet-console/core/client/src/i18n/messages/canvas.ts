export const canvasEn = {
  ...
  "cluster.collapseAria": "Collapse the steps of {title}",
  "cluster.expandAria": "Expand the steps of {title}",
  "cluster.after": "after {steps}",
  "cluster.member.aria": "{label} · step of {title}",
...
export const canvasKo: Record<keyof typeof canvasEn, string> = {
  ...
  "cluster.collapseAria": "{title}의 단계 접기",
  "cluster.expandAria": "{title}의 단계 펼치기",
  "cluster.after": "{steps} 뒤",
  "cluster.member.aria": "{label} · {title}의 단계",
