export const canvasEn = {
  ...
  "canvas.formation.modeKicker": "TACTICAL",
  "canvas.formation.modeTitle": "Switching to Tactical",
  "canvas.formation.modeBody": "Arranging {count} Operations on the grid.",
...
export const canvasKo: Record<keyof typeof canvasEn, string> = {
  ...
  "canvas.formation.modeKicker": "TACTICAL",
  "canvas.formation.modeTitle": "Tactical 전환",
  "canvas.formation.modeBody": "{count}개 Operation을 격자에 정렬합니다.",
