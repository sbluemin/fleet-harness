export const canvasEn = {
  ...
  "canvas.snap.lowZoomNote": "Low zoom — placed at the current view size",
  "canvas.snap.altHint": "Hold ⌥ while dropping to flip the zoom setting once",
  "canvas.snap.guideAria": "Snap slot {index}",
...
export const canvasKo: Record<keyof typeof canvasEn, string> = {
  ...
  "canvas.snap.lowZoomNote": "줌이 낮습니다 — 현재 화면 크기 기준으로 배치됩니다",
  "canvas.snap.altHint": "⌥를 누른 채 놓으면 이번만 줌 설정을 반대로 적용합니다",
  "canvas.snap.guideAria": "스냅 칸 {index}",
