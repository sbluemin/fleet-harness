...
// Console chrome cannot import plugin client sources. These marks mirror
// terminal/client/agent and quota/client/cli-glyphs for launch-menu provider bands.

export type LaunchProviderGlyphId = "codex" | "cursor" | "kimi" | "opencode";
...
export function launchProviderFromGroupId(groupId: string): LaunchProviderGlyphId | null {
  ...
  if (provider === "codex" || provider === "cursor" || provider === "kimi" || provider === "opencode") return provider;
  return null;
}
