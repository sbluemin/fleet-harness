...
import { computeVisibleOperationIds, filterByPreferences, groupNotificationsByTheater, splitNotificationsByVisibility } from "../notification-reduce.js";
              ...
              <section className="notification-cluster-group" key={group.theaterId ?? "__unknown__"}>
                ...
                <ul className="notification-cluster-roster">
                  {group.notifications.map((notification) => (
                    <li className={`notification-row is-${notification.kind}`} key={notification.operationId}>
