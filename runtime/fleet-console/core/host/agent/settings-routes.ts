...
export function registerTerminalSettingsRoutes(ctx: ConsoleRuntimeContext, deps: TerminalSettingsRouteDeps): void {
  registerRouter(ctx, "agent/settings", async ({ req, res }) => {
    if (req.method === "GET") {
