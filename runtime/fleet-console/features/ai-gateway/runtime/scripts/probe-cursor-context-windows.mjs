...
const HELP = `Usage:
  pnpm --silent --filter @fleet-console/ai-gateway probe:cursor-context -- --model <id> [--model <id> ...] [options]
  pnpm --silent --filter @fleet-console/ai-gateway probe:cursor-context -- --all [options]
