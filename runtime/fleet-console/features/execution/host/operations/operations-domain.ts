...
export function createSanitizedOpDto(node: OperationNode, options: OperationSanitizeOptions = {}): OperationNode {
  ...
  // session의 민감 identity는 브라우저에 내보내지 않고 harness/model/effort만 표시 좌표로 남긴다.
...
import type { DeferredDeletionReceipt } from "../../../workspace/host/deferred-deletion.js";
import type { OperationCatalogPlugin } from "../../../../core/host/plugin-host/plugin-host.js";
