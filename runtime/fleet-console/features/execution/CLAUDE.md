...
Agent and Terminal are one execution feature, not plugins. AI Gateway is a separate Console feature. Shell is a non-durable global surface, not an Operation.
