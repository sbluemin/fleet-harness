...
describe("TranscriptIndexer", () => {
  ...
  it("redacts sensitive transcript forms while preserving prose and repository-relative paths", async () => {
    ...
    expect(exposed).toContain("runtime/fleet-console/features/analyst/runtime/src/session.ts");
    expect(exposed).toContain("runtime/fleet-console/features/analyst/runtime/src/tools.ts");
