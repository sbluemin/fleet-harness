...
import { readCachedLatestVersion, writeCachedLatestVersion } from "../src/update/cache.js";
import { checkForUpdate, checkUpdateStatus } from "../src/update/check.js";
import { fetchLatestFleetCliVersion } from "../src/update/registry.js";

vi.mock("../src/update/cache.js", () => ({
  readCachedLatestVersion: vi.fn(),
  writeCachedLatestVersion: vi.fn(),
}));

vi.mock("../src/update/registry.js", () => ({
