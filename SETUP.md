...
- Authenticated [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Codex CLI](https://github.com/openai/codex), or [Gemini CLI](https://github.com/google-gemini/gemini-cli) on PATH
...
pnpm ls -g --depth=0 | grep -E 'fleet-harness|fleet-agent|pi-coding-agent'
...
```bash
# stable
npm install -g @dotobokuri/fleet-agent

# canary
npm install -g @dotobokuri/fleet-agent@canary
```
...
1. Uninstall the npm version: `npm uninstall -g @dotobokuri/fleet-agent`
