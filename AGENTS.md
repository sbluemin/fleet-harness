...
| `packages/` | First-party workspace packages: `fleet-core`, `fleet-wiki`, `fleet-wiki-web`, `fleet-harness-extension` |

> See each directory's `AGENTS.md` for detailed maps: `packages/fleet-core/AGENTS.md`, `packages/fleet-harness-extension/AGENTS.md`, `packages/fleet-wiki/AGENTS.md`, `packages/fleet-wiki-web/AGENTS.md`, and `engines/AGENTS.md`.
