...
| `packages/` | First-party workspace packages: `fleet-core`, `fleet-wiki`, `fleet-wiki-web`, `fleet-harness` (Pi host adapter), and `fleet-dedicated-harness` (embedded CLI TUI PoC) |
