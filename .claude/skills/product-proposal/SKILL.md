...
5. **Verify the mock:** exercise it in Fleet Browser and inspect screenshots. Match mock labels to the target product's actual UI language; explanation follows session language. Never switch or close the user's tabs. Leave the mock for the direction choice.
