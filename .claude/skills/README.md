...
This directory owns repository-work skills. It is separate from what Fleet embeds into a launched agent session — the hooks and the single execution identity rendered from `runtime/fleet-console/foundation/agent-runtime/assets/`. Do not vendor installed external skills here.
