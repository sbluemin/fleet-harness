...
- The public entrypoint is the package root. Codex owns global MCP registration and the Cowork session engine.
- This package has no workspace dependencies. Do not add host, provider, or agent runtime dependencies.
