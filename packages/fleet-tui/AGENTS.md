...
- **Forbidden Workspace Dependencies**: `@sbluemin/fleet-core`, `@sbluemin/fleet-carriers`, `@sbluemin/fleet-agent`, `@sbluemin/fleet-wiki`, `@sbluemin/fleet-wiki-web`, and `@sbluemin/fleet-unified-agent`.
