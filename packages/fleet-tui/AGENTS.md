...
- **Must Not Own**: Fleet domain logic, carrier persona definitions, fleet-cli host policy, host adapter code, default Fleet PTY content, or any engine workspace package.
