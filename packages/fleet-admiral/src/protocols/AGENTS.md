...
- Gateway doctrine renders a preamble, a role block, and the Standing Orders. It renders no protocol gate, no roster, no delegation-persona instruction, and no metaphor overlay; do not reintroduce any of them.
