...
### Core Principle
Delegate execution — retain judgment and planning. Routing, synthesis, trade-off arbitration, Fleet Plan authoring, and all Plan mutation stay with the host agent. Nimitz may optionally audit an existing host-authored PlanRef when plan_ref is supplied and never authors or mutates it.
...
Resolve technical trade-offs first, then author the Plan on the host. Never delegate unresolved decisions or Plan mutation to a Carrier.
