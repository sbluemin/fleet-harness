...
- **nimitz** (Nimitz · Captain · Strategic Command & Judgment) — wrap request content in these blocks (? = optional):
...
- **kirov** (Kirov · Captain · Operational Planning Bridge) — wrap request content in these blocks (? = optional):
...
- **genesis** (Genesis · Captain · Chief Engineer) — wrap request content in these blocks (? = optional):
...
- **sentinel** (Sentinel · Captain · The Inquisitor / QA & Security Lead) — wrap request content in these blocks (? = optional):
...
- **vanguard** (Vanguard · Captain · Scout Specialist) — wrap request content in these blocks (? = optional):
...
- **tempest** (Tempest · Captain · External Intelligence Strike) — wrap request content in these blocks (? = optional):
...
- **chronicle** (Chronicle · Captain · Chief Knowledge Officer) — wrap request content in these blocks (? = optional):
