 ...
 * this one is left to service the call itself, and the shell-first directive stays
 * with the catalog it was written for. Only the skill pruning applies, and that one
 * is a window budget rather than a capability judgement.
 */
