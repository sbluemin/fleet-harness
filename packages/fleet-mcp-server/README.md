...
- **Executor Integration**: Specialized whitelisting and lazy resolution for carrier-tier executor sessions.
...
- `registerExecutorTool(spec: AgentToolSpec, options?: { allowedCarriers?: string[] }): void`: Registers a tool and whitelists it for carrier executor sessions.
