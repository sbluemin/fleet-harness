...
- Fleet carrier metadata, default tool builders, single-fleet prompt composition, and runtime composition stay in `@sbluemin/fleet-admiral`; multi-fleet and Grand Fleet composition stay in `@sbluemin/fleet-admiralty`.
