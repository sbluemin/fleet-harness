...
- Fleet carrier metadata, default tool builders, and single-fleet prompt composition stay in `@dotobokuri/fleet-admiral`; runtime composition stays in `fleet-cli`.
