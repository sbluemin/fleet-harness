...
import type {
	...
	ThinkingLevel,
	ToolExecutionMode,
} from "@sbluemin/fleet-agent-core";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@sbluemin/fleet-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@sbluemin/fleet-coding-agent";
	 *
...
export type BashToolCallEvent = ToolCallEventBase & { toolName: "bash"; input: Record<string, unknown> };
export type ReadToolCallEvent = ToolCallEventBase & { toolName: "read"; input: Record<string, unknown> };
export type EditToolCallEvent = ToolCallEventBase & { toolName: "edit"; input: Record<string, unknown> };
export type WriteToolCallEvent = ToolCallEventBase & { toolName: "write"; input: Record<string, unknown> };
export type GrepToolCallEvent = ToolCallEventBase & { toolName: "grep"; input: Record<string, unknown> };
export type FindToolCallEvent = ToolCallEventBase & { toolName: "find"; input: Record<string, unknown> };
export type LsToolCallEvent = ToolCallEventBase & { toolName: "ls"; input: Record<string, unknown> };
...
export type BashToolResultEvent = ToolResultEventBase & { toolName: "bash"; details: unknown };
export type ReadToolResultEvent = ToolResultEventBase & { toolName: "read"; details: unknown };
export type EditToolResultEvent = ToolResultEventBase & { toolName: "edit"; details: unknown };
export type WriteToolResultEvent = ToolResultEventBase & { toolName: "write"; details: unknown };
export type GrepToolResultEvent = ToolResultEventBase & { toolName: "grep"; details: unknown };
export type FindToolResultEvent = ToolResultEventBase & { toolName: "find"; details: unknown };
export type LsToolResultEvent = ToolResultEventBase & { toolName: "ls"; details: unknown };

/** Fired after a tool executes. Can modify result. */
export type ToolResultEvent = CustomToolResultEvent;

// Type guards for legacy event narrowing helpers.
 ...
 *
 * Tools require explicit type parameters when callers need typed inputs:
 * ```ts
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Default thinking level when no session/model override exists. */
