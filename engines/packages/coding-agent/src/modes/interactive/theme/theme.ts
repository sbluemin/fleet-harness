...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@sbluemin/fleet-tui";
...
const THEME_KEY = Symbol.for("@sbluemin/fleet-coding-agent:theme");
...
export function getSettingsListTheme(): import("@sbluemin/fleet-tui").SettingsListTheme {
	return {
